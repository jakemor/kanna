...
function splitFileSections(lines) {
  const sections = [];
  let current = null;
...
function splitHunkIntoChangeBlocks(hunkLines, { modelContextLines, viewContextLines }) {
...
function isChangedBodyLine(line) {
